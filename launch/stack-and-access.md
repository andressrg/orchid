...
| AI        | ✅ Claude `claude-opus-4-8` via typed `web/app/lib/ai.ts` (`askClaude`/`streamClaude`); OpenAI optional fallback                                             | summary/chat/decisions on Claude (PR #51). Needs `ANTHROPIC_API_KEY` in Vercel prod/preview env (P0-5) |
