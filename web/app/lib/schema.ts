import { boolean, pgTable, text, timestamp, integer, index, jsonb } from 'drizzle-orm/pg-core';
...
export const subscription = pgTable('subscription', {
  ...
  index('idx_subscription_reference').on(t.referenceId),
  index('idx_subscription_stripe_customer').on(t.stripeCustomerId),
  index('idx_subscription_stripe_subscription').on(t.stripeSubscriptionId),
]);
